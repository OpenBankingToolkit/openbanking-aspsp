...
public class DomesticScheduledPaymentApiController implements DomesticScheduledPaymentApi {
    ...
    public ResponseEntity get(
        ...
        Optional<FRDomesticScheduledConsent> byPaymentId = consentRepository.findById(paymentId);
    ...
    @Override
    public ResponseEntity<Collection<FRDomesticScheduledConsent>> findByStatus(
    ...
    @Override
    public ResponseEntity<FRDomesticScheduledConsent> update(
            @RequestBody FRDomesticScheduledConsent paymentSetup
    ) {
