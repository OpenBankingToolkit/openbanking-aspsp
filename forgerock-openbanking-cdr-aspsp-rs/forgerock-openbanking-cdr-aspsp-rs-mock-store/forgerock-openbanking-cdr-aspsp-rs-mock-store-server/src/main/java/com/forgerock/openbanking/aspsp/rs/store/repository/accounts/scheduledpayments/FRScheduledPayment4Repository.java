...
public interface FRScheduledPayment4Repository extends MongoRepository<FRScheduledPayment, String>, FRScheduledPayment4RepositoryCustom {
    ...
    List<FRScheduledPayment> findByStatus(@Param("status") ScheduledPaymentStatus status, @Param("scheduledPayment.ScheduledPaymentDateTime") DateTime maxDateTime);
