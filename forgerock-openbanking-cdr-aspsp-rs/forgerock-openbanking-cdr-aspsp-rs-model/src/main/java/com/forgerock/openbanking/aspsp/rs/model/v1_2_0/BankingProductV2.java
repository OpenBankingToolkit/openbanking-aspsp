...
public class BankingProductV2 {
    ...
    private BankingProductV2AdditionalInformation additionalInformation = null;

    @JsonProperty("cardArt")
    @Valid
    private List<BankingProductV2CardArt> cardArt = null;
    ...
    public BankingProductV2 additionalInformation(BankingProductV2AdditionalInformation additionalInformation) {
    ...
    @Valid
    public BankingProductV2AdditionalInformation getAdditionalInformation() {
        return additionalInformation;
    }

    public void setAdditionalInformation(BankingProductV2AdditionalInformation additionalInformation) {
        this.additionalInformation = additionalInformation;
    }

    public BankingProductV2 cardArt(List<BankingProductV2CardArt> cardArt) {
        this.cardArt = cardArt;
        return this;
    }

    public BankingProductV2 addCardArtItem(BankingProductV2CardArt cardArtItem) {
        if (this.cardArt == null) {
            this.cardArt = new ArrayList<BankingProductV2CardArt>();
        }
