...
public class AccessTokenApiController implements AccessTokenApi {
    ...
    public ResponseEntity getAccessToken(
        ...
        if (clientIDAuthMethod.authMethod == OIDCConstants.TokenEndpointAuthMethods.PRIVATE_KEY_JWT) {
            String clientAssertionSerialised = (String) paramMap.getFirst("client_assertion");
            try {
                SignedJWT clientAssertion = SignedJWT.parse(clientAssertionSerialised);
                clientAssertionSerialised = cryptoApiClient.signClaims(clientAssertion.getJWTClaimsSet().getIssuer(), clientAssertion.getJWTClaimsSet(), false);
                paramMap.replace("client_assertion", Arrays.asList(clientAssertionSerialised));
            ...
            amGateway = amGatewayService.getAmGateway(clientAssertionSerialised);
        }
