...
import com.forgerock.openbanking.aspsp.as.api.registration.dynamic.DynamicRegistrationApiController;
...
public class TppRegistrationService {
    ...
    @Value("${as.gateway.jwk_uri}")
    private String asGatewayJwkUri;
    ...
    public Tpp registerTpp(String cn, String registrationRequestJson,
        ...
        String originalJwkURI = oidcRegistrationRequest.getJwks_uri();
        oidcRegistrationRequest.setJwks_uri(asGatewayJwkUri);
        OIDCRegistrationResponse oidcRegistrationResponse = amoidcRegistrationService.register(oidcRegistrationRequest);
        oidcRegistrationResponse.setJwks_uri(originalJwkURI);
    ...
    public Set<SoftwareStatementRole> prepareRegistrationRequestWithSSA(
        ...
        if (types.contains(SoftwareStatementRole.AISP)) {
            scopes.add(DynamicRegistrationApiController.CDRScope.BANK_ACCOUNT_BASIC_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.BANK_ACCOUNT_DETAILS_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.BANK_PAYEE_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.BANK_REGULAR_PAYMENT_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.BANK_TRANSACTIONS_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.COMMON_CUSTOMER_BASIC_READ);
            scopes.add(DynamicRegistrationApiController.CDRScope.COMMON_CUSTOMER_DETAILS_READ);
        }
