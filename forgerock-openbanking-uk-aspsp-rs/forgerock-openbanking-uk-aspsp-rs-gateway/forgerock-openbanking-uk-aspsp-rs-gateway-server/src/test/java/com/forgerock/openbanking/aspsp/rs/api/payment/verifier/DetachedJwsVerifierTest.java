...
public class DetachedJwsVerifierTest {
    ...
    final private String OAUTH2_CLIENT_ID = "oauth2ClientId";
    ...
    public void shouldVerifyDetachedJwsGivenVersionBefore3_1_4AndB64HeaderIsFalse() throws Exception {
        ...
        // When
        detachedJwsVerifier.verifyDetachedJws(detachedJws, OBVersion.v3_1_3, request, OAUTH2_CLIENT_ID);
    ...
    public void shouldVerifyDetachedJwsGivenVersion3_1_4AndB64HeaderIsMissing() throws Exception {
        ...
        // When
        detachedJwsVerifier.verifyDetachedJws(detachedJws, OBVersion.v3_1_4, request, OAUTH2_CLIENT_ID);
