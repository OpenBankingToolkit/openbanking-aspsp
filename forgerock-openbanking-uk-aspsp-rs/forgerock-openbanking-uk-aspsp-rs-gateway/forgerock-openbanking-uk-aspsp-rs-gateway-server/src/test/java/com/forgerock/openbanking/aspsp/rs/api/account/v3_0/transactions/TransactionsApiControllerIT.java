...
public class TransactionsApiControllerIT {
    ...
    public void getAccountTransactionShouldBeOk() throws Exception {
        ...
        OBReadTransaction3 transaction = new OBReadTransaction3();
        given(rsStoreGateway.toRsStore(any(), any(), any(), any())).willReturn(ResponseEntity.ok(transaction));

        // When
        HttpResponse<OBReadTransaction3> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.0/aisp/accounts/100000123/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
                .asObject(OBReadTransaction3.class);
    ...
    public void getAccountStatementTransactionShouldBeOk() throws Exception {
        ...
        // When
        HttpResponse<OBReadTransaction3> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.0/aisp/accounts/100000123/statements/1000001234/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
                .asObject(OBReadTransaction3.class);
    ...
    public void getTransactionShouldBeOk() throws Exception {
        ...
        // When
        HttpResponse<OBReadTransaction3> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.0/aisp/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
                .asObject(OBReadTransaction3.class);
