 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v3_1_7.transactions;
...
/**
 * SpringBoot test for {@link com.forgerock.openbanking.aspsp.rs.api.account.v3_1_7.transactions.TransactionsApiController}.
 */
...
public class TransactionsApiControllerIT {
    ...
    public void getAccountTransactionShouldBeOk() throws Exception {
        ...
        // When
        HttpResponse<OBReadTransaction4> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.1.7/aisp/accounts/100000123/transactions")
    ...
    public void getAccountStatementTransactionShouldBeOk() throws Exception {
        ...
        // When
        HttpResponse<OBReadTransaction4> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.1.7/aisp/accounts/100000123/statements/1000001234/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
                .asObject(OBReadTransaction4.class);
    ...
    public void getTransactionShouldBeOk() throws Exception {
        ...
        // When
        HttpResponse<OBReadTransaction4> response = Unirest.get("https://rs-api:" + port + "/open-banking/v3.1.7/aisp/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
                .asObject(OBReadTransaction4.class);
    ...
    public void shouldContainTransactionMetics() throws Exception {
        ...
        // When
        Unirest.get("https://rs-api:" + port + "/open-banking/v3.1.7/aisp/accounts/100000123/transactions")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "Bearer " + jws)
        ...
        assertThat(metricService.getEndpointUsageMetric()
                .stream().filter(e -> e.getEndpoint().equals("/open-banking/v3.1.7/aisp/accounts/{AccountId}/transactions"))
                .findAny())
                .isNotEmpty();
    }
