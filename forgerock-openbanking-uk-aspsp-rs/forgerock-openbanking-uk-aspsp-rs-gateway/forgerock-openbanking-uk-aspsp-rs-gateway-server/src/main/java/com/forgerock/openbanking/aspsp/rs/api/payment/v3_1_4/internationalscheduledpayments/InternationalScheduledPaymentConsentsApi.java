...
public interface InternationalScheduledPaymentConsentsApi {
    @ApiOperation(value = "Create International Scheduled Payment Consents", nickname = "createInternationalScheduledPaymentConsents", notes = "", response = OBWriteInternationalScheduledConsentResponse5.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Scheduled Payment Consents Created", response = OBWriteInternationalScheduledConsentResponse5.class),
    ...
    @OpenBankingAPI(
            obReference = OBReference.CREATE_INTERNATIONAL_SCHEDULED_PAYMENT_CONSENT
    )
    ...
    ResponseEntity<OBWriteInternationalScheduledConsentResponse5> createInternationalScheduledPaymentConsents(
    ...
    @ApiOperation(value = "Get International Scheduled Payment Consents", nickname = "getInternationalScheduledPaymentConsentsConsentId", notes = "", response = OBWriteInternationalScheduledConsentResponse5.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Scheduled Payment Consents Read", response = OBWriteInternationalScheduledConsentResponse5.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    @PreAuthorize("hasAuthority('ROLE_PISP')")
    @OpenBankingAPI(
            obReference = OBReference.GET_INTERNATIONAL_SCHEDULED_PAYMENT_CONSENT
    )
    @RequestMapping(value = "/international-scheduled-payment-consents/{ConsentId}",
            produces = {"application/json; charset=utf-8", "application/jose+jwe"},
            method = RequestMethod.GET)
    ResponseEntity<OBWriteInternationalScheduledConsentResponse5> getInternationalScheduledPaymentConsentsConsentId(
    ...
    @ApiOperation(value = "Get International Scheduled Payment Consents Funds Confirmation", nickname = "getInternationalScheduledPaymentConsentsConsentIdFundsConfirmation", notes = "", response = OBWriteFundsConfirmationResponse1.class, authorizations = {
    ...
    @PreAuthorize("hasAuthority('ROLE_PISP')")
    @OpenBankingAPI(
            obReference = OBReference.GET_INTERNATIONAL_SCHEDULED_PAYMENT_CONSENTS_CONSENT_ID_FUNDS_CONFIRMATION
    )
