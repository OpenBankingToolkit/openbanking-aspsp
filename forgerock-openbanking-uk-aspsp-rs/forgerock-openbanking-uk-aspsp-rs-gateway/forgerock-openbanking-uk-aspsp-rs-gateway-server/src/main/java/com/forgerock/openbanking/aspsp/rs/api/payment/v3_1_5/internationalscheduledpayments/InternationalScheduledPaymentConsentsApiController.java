 ...
 */
package com.forgerock.openbanking.aspsp.rs.api.payment.v3_1_5.internationalscheduledpayments;
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteInternationalScheduledConsentResponse6.class, OBWriteInternationalScheduledConsent5);
                        }
                );
    }

    public ResponseEntity<OBWriteInternationalScheduledConsentResponse6> getInternationalScheduledPaymentConsentsConsentId(
            String consentId,
            String authorization,
            DateTime xFapiAuthDate,
            String xFapiCustomerIpAddress,
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            additionalHttpHeaders.add("x-ob-client-id", tppId);
                            ParameterizedTypeReference<OBWriteInternationalScheduledConsentResponse6> ptr = new ParameterizedTypeReference<OBWriteInternationalScheduledConsentResponse6>() {
                            };
