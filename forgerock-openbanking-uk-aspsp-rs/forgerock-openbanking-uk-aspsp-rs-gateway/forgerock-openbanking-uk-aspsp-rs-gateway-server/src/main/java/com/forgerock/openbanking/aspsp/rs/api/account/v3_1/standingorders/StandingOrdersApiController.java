 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v3_1.standingorders;
...
public class StandingOrdersApiController implements StandingOrdersApi {
    ...
    @Override
    public ResponseEntity<OBReadStandingOrder4> getAccountStandingOrders(
        ...
        return RSEndpointWrapperService.<OBReadStandingOrder4>accountAndTransactionEndpoint()
                ...
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadStandingOrder4.class);
                        }
                );
    }

    @Override
    public ResponseEntity<OBReadStandingOrder4> getStandingOrders(
