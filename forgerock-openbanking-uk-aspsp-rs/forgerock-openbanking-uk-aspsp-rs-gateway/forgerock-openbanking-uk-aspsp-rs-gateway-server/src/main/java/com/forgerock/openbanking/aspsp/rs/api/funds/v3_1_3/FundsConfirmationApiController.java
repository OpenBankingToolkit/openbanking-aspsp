...
@Controller("FundsConfirmationApiV3.1.3")
public class FundsConfirmationApiController implements FundsConfirmationApi {
    ...
    private final com.forgerock.openbanking.aspsp.rs.api.funds.v3_1_2.FundsConfirmationApiController previousVersionController;

    public FundsConfirmationApiController(
            RSEndpointWrapperService rsEndpointWrapperService,
            @Qualifier("FundsConfirmationApiV3.1.2") com.forgerock.openbanking.aspsp.rs.api.funds.v3_1_2.FundsConfirmationApiController previousVersionController
    ) {
    ...
    @Override
    public ResponseEntity createFundsConfirmation(@Valid OBFundsConfirmation1 obFundsConfirmation1,
    ...
    @Override
    public ResponseEntity<OBFundsConfirmationResponse1> getFundsConfirmationId(String fundsConfirmationId,
                                                                               String authorization,
                                                                               DateTime xFapiAuthDate,
                                                                               String xFapiCustomerIpAddress,
                                                                               String xFapiInteractionId,
