        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteFileConsentResponse4.class, obWriteFileConsent3);
                        }
                );
    }
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteFileConsentResponse4.class);
                        }
                );
    }
