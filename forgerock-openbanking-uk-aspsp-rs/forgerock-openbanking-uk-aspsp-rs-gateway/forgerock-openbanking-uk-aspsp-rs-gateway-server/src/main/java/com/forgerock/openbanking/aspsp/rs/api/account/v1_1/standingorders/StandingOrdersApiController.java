 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v1_1.standingorders;
        ...
        return RSEndpointWrapperService.<OBReadStandingOrder1>accountAndTransactionEndpoint()
                ...
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadStandingOrder1.class);
                        }
                );
    }
