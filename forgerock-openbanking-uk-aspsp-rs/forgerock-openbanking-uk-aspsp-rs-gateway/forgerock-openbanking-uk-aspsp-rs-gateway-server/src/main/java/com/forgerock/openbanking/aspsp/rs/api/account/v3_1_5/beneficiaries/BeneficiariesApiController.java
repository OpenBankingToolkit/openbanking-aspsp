 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v3_1_5.beneficiaries;
...
public class BeneficiariesApiController implements BeneficiariesApi {
    ...
    public ResponseEntity<OBReadBeneficiary5> getAccountBeneficiaries(String accountId,
        ...
        return rsEndpointWrapperService.<OBReadBeneficiary5>accountAndTransactionEndpoint()
                ...
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadBeneficiary5.class);
                        }
                );
    }

    @Override
    public ResponseEntity<OBReadBeneficiary5> getBeneficiaries(String page,
                                                               String authorization,
                                                               DateTime xFapiAuthDate,
                                                               String xFapiCustomerIpAddress,
                                                               String xFapiInteractionId,
        ...
        return rsEndpointWrapperService.<OBReadBeneficiary5>accountAndTransactionEndpoint()
                ...
                .principal(principal)
                .page(page)
                .minimumPermissions(OBExternalPermissions1Code.READBENEFICIARIESBASIC, OBExternalPermissions1Code.READBENEFICIARIESDETAIL)
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
