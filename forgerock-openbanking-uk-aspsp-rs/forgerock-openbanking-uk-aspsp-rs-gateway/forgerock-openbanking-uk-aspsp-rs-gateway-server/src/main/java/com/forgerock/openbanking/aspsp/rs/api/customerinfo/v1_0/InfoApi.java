...
@OpenBankingAPI(
        obVersion = "1.0",
        obGroupName = OBGroupName.INFO,
        obReference = OBReference.CUSTOMER_INFO
)
...
public interface InfoApi {
    ...
    @OpenBankingAPI(
            obReference = OBReference.GET_CUSTOMER_INFO
    )
    default ResponseEntity<ReadCustomerInfo> getCustomerInfo(
            ...
            @RequestHeader(value="x-fapi-interaction-id", required=false)
                    String xFapiInteractionId,@ApiParam(value = "Indicates the user-agent that the PSU is using." )
