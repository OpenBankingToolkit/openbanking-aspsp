...
public interface DomesticPaymentsApi {
    ...
    @OpenBankingAPI(
            obReference = OBReference.CREATE_DOMESTIC_PAYMENT
    )
    ...
    @PreAuthorize("hasAuthority('ROLE_PISP')")
    @OpenBankingAPI(
            obReference = OBReference.GET_DOMESTIC_PAYMENT
    )
    ...
    @PreAuthorize("hasAuthority('ROLE_PISP')")
    @OpenBankingAPI(
            obReference = OBReference.GET_DOMESTIC_PAYMENTS_DOMESTIC_PAYMENT_ID_PAYMENT_DETAILS
    )
