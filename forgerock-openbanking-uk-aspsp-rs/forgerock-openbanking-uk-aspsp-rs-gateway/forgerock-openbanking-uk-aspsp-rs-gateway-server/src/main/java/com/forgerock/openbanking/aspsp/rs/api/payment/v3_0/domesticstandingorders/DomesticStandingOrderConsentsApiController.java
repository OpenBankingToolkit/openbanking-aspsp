        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteDomesticStandingOrderConsentResponse1.class, obWriteDomesticStandingOrderConsent1Param);
                        }
                );
    }

    @Override
    public ResponseEntity<OBWriteDomesticStandingOrderConsentResponse1> getDomesticStandingOrderConsentsConsentId(
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteDomesticStandingOrderConsentResponse1.class);
                        }
                );
    }
