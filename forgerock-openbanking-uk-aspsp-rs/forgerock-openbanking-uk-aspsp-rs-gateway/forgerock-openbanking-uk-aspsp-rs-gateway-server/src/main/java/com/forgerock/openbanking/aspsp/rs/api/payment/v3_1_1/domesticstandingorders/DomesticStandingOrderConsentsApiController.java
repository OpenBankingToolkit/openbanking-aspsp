...
public class DomesticStandingOrderConsentsApiController implements DomesticStandingOrderConsentsApi {
    ...
    @Override
    public ResponseEntity<OBWriteDomesticStandingOrderConsentResponse3> getDomesticStandingOrderConsentsConsentId(
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteDomesticStandingOrderConsentResponse3.class);
                        }
                );
    }
