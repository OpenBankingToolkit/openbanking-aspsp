...
public interface DomesticScheduledPaymentConsentsApi {
    ...
    @ApiOperation(value = "Create Domestic Scheduled Payment Consents", nickname = "createDomesticScheduledPaymentConsents", notes = "", response = OBWriteDomesticScheduledConsentResponse3.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Scheduled Payment Consents Created", response = OBWriteDomesticScheduledConsentResponse3.class),
    ...
    ResponseEntity<OBWriteDomesticScheduledConsentResponse3> createDomesticScheduledPaymentConsents(

            @ApiParam(value = "Default", required = true) @Valid @RequestBody OBWriteDomesticScheduledConsent3 obWriteDomesticScheduledConsent3Param,
    ...
    @ApiOperation(value = "Get Domestic Scheduled Payment Consents", nickname = "getDomesticScheduledPaymentConsentsConsentId", notes = "", response = OBWriteDomesticScheduledConsentResponse3.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Scheduled Payment Consents Read", response = OBWriteDomesticScheduledConsentResponse3.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
