...
@OpenBankingAPI(
        ...
        obReference = OBReference.INTERNATIONAL_SCHEDULED_PAYMENTS
)
@RequestMapping(value = "/open-banking/v3.1.10/pisp")
public interface InternationalScheduledPaymentConsentsApi extends com.forgerock.openbanking.aspsp.rs.api.payment.v3_1_9.internationalscheduledpayments.InternationalScheduledPaymentConsentsApi {
}
