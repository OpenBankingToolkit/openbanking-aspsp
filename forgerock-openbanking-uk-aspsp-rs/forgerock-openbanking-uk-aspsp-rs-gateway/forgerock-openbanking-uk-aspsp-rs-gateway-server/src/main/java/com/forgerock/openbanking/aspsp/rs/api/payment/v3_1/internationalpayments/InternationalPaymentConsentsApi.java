...
public interface InternationalPaymentConsentsApi {
    ...
    @ApiOperation(value = "Create International Payment Consents", nickname = "createInternationalPaymentConsents", notes = "", response = OBWriteInternationalConsentResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Payment Consents Created", response = OBWriteInternationalConsentResponse2.class),
    ...
    ResponseEntity<OBWriteInternationalConsentResponse2> createInternationalPaymentConsents(
    ...
    @ApiOperation(value = "Get International Payment Consents", nickname = "getInternationalPaymentConsentsConsentId", notes = "", response = OBWriteInternationalConsentResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Payment Consents Read", response = OBWriteInternationalConsentResponse2.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    ResponseEntity<OBWriteInternationalConsentResponse2> getInternationalPaymentConsentsConsentId(
    ...
    @ApiOperation(value = "Get International Payment Consents Funds Confirmation",
            nickname = "getInternationalPaymentConsentsConsentIdFundsConfirmation", notes = "",
            response = OBWriteFundsConfirmationResponse1.class, authorizations = {
