...
public class DomesticPaymentsApiController implements DomesticPaymentsApi {
    ...
    public ResponseEntity<OBWriteDomesticResponse5> getDomesticPaymentsDomesticPaymentId(
        ...
        return rsEndpointWrapperService.paymentsRequestPaymentIdEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteDomesticResponse5.class);
                        }
                );
    }
