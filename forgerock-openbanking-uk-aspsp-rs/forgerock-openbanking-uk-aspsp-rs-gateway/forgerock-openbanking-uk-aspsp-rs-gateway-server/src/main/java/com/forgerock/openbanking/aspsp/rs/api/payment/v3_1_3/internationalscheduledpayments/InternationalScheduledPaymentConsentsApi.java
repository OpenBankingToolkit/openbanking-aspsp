...
public interface InternationalScheduledPaymentConsentsApi {
    ...
    @ApiOperation(value = "Create International Scheduled Payment Consents", nickname = "createInternationalScheduledPaymentConsents", notes = "", response = OBWriteInternationalScheduledConsentResponse4.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "International Scheduled Payment Consents Created", response = OBWriteInternationalScheduledConsentResponse4.class),
    ...
    ResponseEntity<OBWriteInternationalScheduledConsentResponse4> createInternationalScheduledPaymentConsents(
    ...
    @ApiOperation(value = "Get International Scheduled Payment Consents", nickname = "getInternationalScheduledPaymentConsentsConsentId", notes = "", response = OBWriteInternationalScheduledConsentResponse4.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"International Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "International Scheduled Payment Consents Read", response = OBWriteInternationalScheduledConsentResponse4.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 404, message = "Not found"),
