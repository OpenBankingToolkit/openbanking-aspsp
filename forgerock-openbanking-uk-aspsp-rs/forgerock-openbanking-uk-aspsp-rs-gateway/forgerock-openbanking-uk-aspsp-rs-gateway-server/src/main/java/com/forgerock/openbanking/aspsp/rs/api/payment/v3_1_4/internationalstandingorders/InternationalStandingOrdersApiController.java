...
public class InternationalStandingOrdersApiController implements InternationalStandingOrdersApi {
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .filters(f -> {
                    ...
                    f.verifyRiskAndInitiation(
                            toFRWriteInternationalStandingOrderDataInitiation(obWriteInternationalStandingOrder4.getData().getInitiation()),
                            toFRRisk(obWriteInternationalStandingOrder4.getRisk()));
    ...
    @Override
    public ResponseEntity<OBWriteInternationalStandingOrderResponse6> getInternationalStandingOrdersInternationalStandingOrderPaymentId(
        ...
        return rsEndpointWrapperService.paymentsRequestPaymentIdEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteInternationalStandingOrderResponse6.class);
                        }
                );
    }
