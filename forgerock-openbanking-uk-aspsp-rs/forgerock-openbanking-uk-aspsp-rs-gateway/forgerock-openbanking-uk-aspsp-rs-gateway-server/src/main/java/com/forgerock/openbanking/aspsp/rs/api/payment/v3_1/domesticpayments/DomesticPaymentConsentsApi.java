...
public interface DomesticPaymentConsentsApi {
    ...
    ResponseEntity<OBWriteDomesticConsentResponse2> createDomesticPaymentConsents(
    ...
    @ApiOperation(value = "Get Domestic Payment Consents", nickname = "getDomesticPaymentConsentsConsentId", notes = "", response = OBWriteDomesticConsentResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Payment Consents Read", response = OBWriteDomesticConsentResponse2.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 405, message = "Method Not Allowed"),
    ...
    ResponseEntity<OBWriteDomesticConsentResponse2> getDomesticPaymentConsentsConsentId(
