...
public interface DomesticPaymentConsentsApi {
    ...
    @ApiOperation(value = "Create Domestic Payment Consents", nickname = "createDomesticPaymentConsents", notes = "", response = OBWriteDomesticConsentResponse4.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Payment Consents Created", response = OBWriteDomesticConsentResponse4.class),
    ...
    ResponseEntity<OBWriteDomesticConsentResponse4> createDomesticPaymentConsents(
    ...
    @ApiOperation(value = "Get Domestic Payment Consents", nickname = "getDomesticPaymentConsentsConsentId", notes = "", response = OBWriteDomesticConsentResponse4.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Payment Consents Read", response = OBWriteDomesticConsentResponse4.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden", response = OBErrorResponse1.class),
            @ApiResponse(code = 405, message = "Method Not Allowed"),
    ...
    ResponseEntity<OBWriteDomesticConsentResponse4> getDomesticPaymentConsentsConsentId(
    ...
    @ApiOperation(value = "Get Domestic Payment Consents Funds Confirmation", nickname = "getDomesticPaymentConsentsConsentIdFundsConfirmation", notes = "", response = OBWriteFundsConfirmationResponse1.class, authorizations = {
            @Authorization(value = "PSUOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "", description = "")})}, tags = {"Domestic Payments",})
    @ApiResponses(value = {
