...
public interface DomesticStandingOrderConsentsApi {
    ...
    @ApiOperation(value = "Create Domestic Standing Order Consents", nickname = "createDomesticStandingOrderConsents", notes = "", response = OBWriteDomesticStandingOrderConsentResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Standing Orders",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Standing Order Consents Created", response = OBWriteDomesticStandingOrderConsentResponse2.class),
    ...
    ResponseEntity<OBWriteDomesticStandingOrderConsentResponse2> createDomesticStandingOrderConsents(
    ...
    @ApiOperation(value = "Get Domestic Standing Order Consents", nickname = "getDomesticStandingOrderConsentsConsentId", notes = "", response = OBWriteDomesticStandingOrderConsentResponse2.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Standing Orders",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Standing Order Consents Read", response = OBWriteDomesticStandingOrderConsentResponse2.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    ResponseEntity<OBWriteDomesticStandingOrderConsentResponse2> getDomesticStandingOrderConsentsConsentId(
