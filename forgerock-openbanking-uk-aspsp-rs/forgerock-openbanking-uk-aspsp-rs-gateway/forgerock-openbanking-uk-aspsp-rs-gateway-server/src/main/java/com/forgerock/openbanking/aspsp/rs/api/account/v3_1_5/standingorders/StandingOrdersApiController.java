...
public class StandingOrdersApiController implements StandingOrdersApi {
    ...
    public ResponseEntity<OBReadStandingOrder6> getAccountStandingOrders(String accountId,
        ...
        return rsEndpointWrapperService.<OBReadStandingOrder6>accountAndTransactionEndpoint()
    ...
    @Override
    public ResponseEntity<OBReadStandingOrder6> getStandingOrders(String page,
                                                                  String authorization,
                                                                  DateTime xFapiAuthDate,
                                                                  String xFapiCustomerIpAddress,
                                                                  String xFapiInteractionId,
