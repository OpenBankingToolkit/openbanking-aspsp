...
public interface StatementsApi {
    ...
    ResponseEntity<OBReadStatement2> getAccountStatements(
            ...
            @ApiParam(value = "The UTC ISO 8601 Date Time to filter transactions FROM NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")
            @RequestParam(value = FROM_BOOKING_DATE_TIME, required = false) DateTime fromBookingDateTime,

            @ApiParam(value = "The UTC ISO 8601 Date Time to filter transactions TO NB Time component is optional - set to 00:00:00 for just Date. If the Date Time contains a timezone, the ASPSP must ignore the timezone component.")
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Statement successfully retrieved", response = OBReadStatement2.class),
            @ApiResponse(code = 400, message = "Bad request"),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
