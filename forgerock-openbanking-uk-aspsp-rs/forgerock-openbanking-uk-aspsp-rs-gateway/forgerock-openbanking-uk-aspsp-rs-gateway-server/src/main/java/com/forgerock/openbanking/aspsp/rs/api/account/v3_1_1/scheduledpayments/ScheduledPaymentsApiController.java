 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v3_1_1.scheduledpayments;
...
public class ScheduledPaymentsApiController implements ScheduledPaymentsApi {
    ...
    public ResponseEntity<OBReadScheduledPayment2> getAccountScheduledPayments(
        ...
        return RSEndpointWrapperService.<OBReadScheduledPayment2>accountAndTransactionEndpoint()
                ...
                .page(page)
                .minimumPermissions(
                        FRExternalPermissionsCode.READSCHEDULEDPAYMENTSBASIC,
                ...
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadScheduledPayment2.class);
                        }
                );
    }
    ...
    public ResponseEntity<OBReadScheduledPayment2> getScheduledPayments(
        ...
        return RSEndpointWrapperService.<OBReadScheduledPayment2>accountAndTransactionEndpoint()
                ...
                .principal(principal)
                .page(page)
                .minimumPermissions(FRExternalPermissionsCode.READSCHEDULEDPAYMENTSBASIC,
                        FRExternalPermissionsCode.READSCHEDULEDPAYMENTSDETAIL)
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
