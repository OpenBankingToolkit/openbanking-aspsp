...
public class DomesticScheduledPaymentsApiController implements DomesticScheduledPaymentsApi {
    ...
    public ResponseEntity<OBWriteDomesticScheduledResponse4> createDomesticScheduledPayments(
            ...
            String xJwsSignature, String xFapiAuthDate,
    ...
    @Override
    public ResponseEntity<OBWriteDomesticScheduledResponse4> getDomesticScheduledPaymentsDomesticScheduledPaymentId(
        ...
        return rsEndpointWrapperService.paymentsRequestPaymentIdEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteDomesticScheduledResponse4.class);
                        }
                );
    }
