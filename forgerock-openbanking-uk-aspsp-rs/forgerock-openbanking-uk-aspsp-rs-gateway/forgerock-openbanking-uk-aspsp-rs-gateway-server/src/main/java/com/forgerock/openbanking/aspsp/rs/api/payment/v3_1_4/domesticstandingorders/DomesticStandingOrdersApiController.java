...
public class DomesticStandingOrdersApiController implements DomesticStandingOrdersApi {
    ...
    @Override
    public ResponseEntity<OBWriteDomesticStandingOrderResponse5> getDomesticStandingOrdersDomesticStandingOrderId(
        ...
        return rsEndpointWrapperService.paymentsRequestPaymentIdEndpoint()
                ...
                .obVersion(getOBVersion(request.getRequestURI()))
                .execute(
                        (String tppId) -> rsStoreGateway.toRsStore(request, new HttpHeaders(), OBWriteDomesticStandingOrderResponse5.class)
                );
    }
