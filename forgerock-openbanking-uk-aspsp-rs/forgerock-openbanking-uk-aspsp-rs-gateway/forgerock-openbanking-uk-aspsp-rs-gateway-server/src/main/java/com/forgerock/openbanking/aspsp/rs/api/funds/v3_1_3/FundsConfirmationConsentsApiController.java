...
public class FundsConfirmationConsentsApiController implements FundsConfirmationConsentsApi {
    ...
    private final com.forgerock.openbanking.aspsp.rs.api.funds.v3_1_2.FundsConfirmationConsentsApiController previousVersionController;

    public FundsConfirmationConsentsApiController(
            RSEndpointWrapperService rsEndpointWrapperService,
            @Qualifier("FundsConfirmationConsentsApiV3.1.2") com.forgerock.openbanking.aspsp.rs.api.funds.v3_1_2.FundsConfirmationConsentsApiController previousVersionController
    ) {
    ...
    @Override
    public ResponseEntity<OBFundsConfirmationConsentResponse1> createFundsConfirmationConsent(@Valid OBFundsConfirmationConsent1 obFundsConfirmationConsent1,
    ...
    @Override
    public ResponseEntity<OBFundsConfirmationConsentResponse1> getFundsConfirmationConsentsConsentId(String consentId,
                                                                                                     String authorization,
                                                                                                     DateTime xFapiAuthDate,
                                                                                                     String xFapiCustomerIpAddress,
                                                                                                     String xFapiInteractionId,
