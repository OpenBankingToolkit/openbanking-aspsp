...
@Api(tags = "v3.1.2-account-access-consents", description = "the account-access-consents API")
@OpenBankingAPI(
        obVersion = "3.1.2",
...
public interface AccountAccessConsentsApi extends com.forgerock.openbanking.aspsp.rs.api.account.v3_1_1.accountaccessconsent.AccountAccessConsentsApi {
}
