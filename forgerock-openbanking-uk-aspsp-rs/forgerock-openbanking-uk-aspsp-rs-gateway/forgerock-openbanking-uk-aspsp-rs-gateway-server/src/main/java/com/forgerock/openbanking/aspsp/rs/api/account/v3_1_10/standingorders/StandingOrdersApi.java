...
@Api(tags = "v3.1.10-Standing-Orders", description = "the standing-orders API")
@OpenBankingAPI(
        obVersion = "3.1.10",
...
public interface StandingOrdersApi extends com.forgerock.openbanking.aspsp.rs.api.account.v3_1_9.standingorders.StandingOrdersApi {
}
