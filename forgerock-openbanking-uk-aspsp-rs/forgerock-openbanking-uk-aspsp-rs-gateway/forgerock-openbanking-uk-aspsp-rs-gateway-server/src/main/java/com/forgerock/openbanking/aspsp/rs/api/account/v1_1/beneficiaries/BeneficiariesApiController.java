 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v1_1.beneficiaries;
        ...
        return RSEndpointWrapperService.<OBReadBeneficiary1>accountAndTransactionEndpoint()
                ...
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadBeneficiary1.class);
                        }
                );
    }
