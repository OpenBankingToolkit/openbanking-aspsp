    ...
    public ResponseEntity<OBWriteInternationalConsentResponse4> createInternationalPaymentConsents(
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .filters(f -> {
                            ...
                            f.validateRisk(obWriteInternationalConsent4.getRisk());
                        }
                )
                .execute(
                        (String tppId) -> {
                            exchangeRateVerifier.verify(obWriteInternationalConsent4.getData().getInitiation().getExchangeRateInformation());

                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            additionalHttpHeaders.add("x-ob-client-id", tppId);

                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteInternationalConsentResponse4.class, obWriteInternationalConsent4);
                        }
                );
    }
