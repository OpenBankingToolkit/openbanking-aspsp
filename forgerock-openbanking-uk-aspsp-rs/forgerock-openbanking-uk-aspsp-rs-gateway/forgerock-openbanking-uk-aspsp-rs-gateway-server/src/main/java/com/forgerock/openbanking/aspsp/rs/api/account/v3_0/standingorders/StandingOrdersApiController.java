 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v3_0.standingorders;
...
public class StandingOrdersApiController implements StandingOrdersApi {
    ...
    public ResponseEntity<OBReadStandingOrder3> getAccountStandingOrders(
        ...
        return RSEndpointWrapperService.<OBReadStandingOrder3>accountAndTransactionEndpoint()
