 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.api.account.v1_1.balances;
...
public class BalancesApiController implements BalancesApi {
    ...
    public ResponseEntity<OBReadBalance1> getBalances(
        ...
        return RSEndpointWrapperService.<OBReadBalance1>accountAndTransactionEndpoint()
                .authorization(authorization)
                .xFapiFinancialId(xFapiFinancialId)
                .principal(principal)
                .page(page)
                .minimumPermissions(FRExternalPermissionsCode.READBALANCES)
                .execute(
                        (accountRequest, permissions, pageNumber) -> {
                            LOGGER.info("Reading balances with id {}", accountRequest.getAccountIds());
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBReadBalance1.class);
                        }
                );
    }
