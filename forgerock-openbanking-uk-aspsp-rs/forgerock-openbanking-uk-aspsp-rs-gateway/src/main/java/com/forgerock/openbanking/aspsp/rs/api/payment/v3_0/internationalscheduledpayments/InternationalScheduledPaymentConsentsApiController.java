...
public class InternationalScheduledPaymentConsentsApiController implements InternationalScheduledPaymentConsentsApi {
    ...
    public InternationalScheduledPaymentConsentsApiController(RSEndpointWrapperService rsEndpointWrapperService, RsStoreGateway rsStoreGateway, ExchangeRateVerifier exchangeRateVerifier) {
    ...
    public ResponseEntity<OBWriteInternationalScheduledConsentResponse1> createInternationalScheduledPaymentConsents(
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            exchangeRateVerifier.verify(obWriteInternationalScheduledConsent1Param.getData().getInitiation().getExchangeRateInformation());

                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            additionalHttpHeaders.add("x-ob-client-id", tppId);

                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteInternationalScheduledConsentResponse1.class, obWriteInternationalScheduledConsent1Param);
                        }
                );
    }
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteInternationalScheduledConsentResponse1.class);
                        }
                );
    }
