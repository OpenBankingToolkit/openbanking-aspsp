...
import com.forgerock.openbanking.commons.services.openbanking.converter.payment.FRFileConsentConverter;
...
public class FilePaymentsApiController implements FilePaymentsApi {
    ...
    public ResponseEntity<OBWriteFileResponse1> createFilePayments(
        ...
        String consentId = obWriteFile1Param.getData().getConsentId();
        FRFileConsent2 payment = paymentsService.getPayment(consentId);
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .filters(f -> {
                    ...
                    f.verifyInitiation(obWriteFile1Param.getData().getInitiation());
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteFileResponse1.class, obWriteFile1Param);
                        }
                );
    }

    @Override
    public ResponseEntity<OBWriteFileResponse1> getFilePaymentsFilePaymentId(
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteFileResponse1.class);
                        }
                );
    }

    @Override
    public ResponseEntity<Resource> getFilePaymentsFilePaymentIdReportFile(
            @ApiParam(value = "FilePaymentId", required = true)
            @PathVariable("FilePaymentId") String filePaymentId,
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            return rsStoreGateway.toRsStore(request, new HttpHeaders(), Resource.class);
                        }
                );
    }
