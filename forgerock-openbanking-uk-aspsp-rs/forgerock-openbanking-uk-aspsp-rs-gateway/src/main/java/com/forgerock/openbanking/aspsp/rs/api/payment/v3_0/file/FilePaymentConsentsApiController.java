...
public class FilePaymentConsentsApiController implements FilePaymentConsentsApi {
    ...
    @Override
    public ResponseEntity<OBWriteFileConsentResponse1> getFilePaymentConsentsConsentId(
            @ApiParam(value = "ConsentId", required = true)
            @PathVariable("ConsentId") String consentId,
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteFileConsentResponse1.class);
                        }
                );
    }

    @Override
    public ResponseEntity<Resource> getFilePaymentConsentsConsentIdFile(
            @ApiParam(value = "ConsentId", required = true)
            @PathVariable("ConsentId") String consentId,
