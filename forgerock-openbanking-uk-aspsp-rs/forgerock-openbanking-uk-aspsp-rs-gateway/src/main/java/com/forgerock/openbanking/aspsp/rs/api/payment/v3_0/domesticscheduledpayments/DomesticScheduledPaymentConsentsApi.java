...
public interface DomesticScheduledPaymentConsentsApi {
    ...
    @ApiOperation(value = "Create Domestic Scheduled Payment Consents", nickname = "createDomesticScheduledPaymentConsents", notes = "", response = OBWriteDomesticScheduledConsentResponse1.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Domestic Scheduled Payment Consents Created", response = OBWriteDomesticScheduledConsentResponse1.class),
    ...
    ResponseEntity<OBWriteDomesticScheduledConsentResponse1> createDomesticScheduledPaymentConsents(
    ...
    @ApiOperation(value = "Get Domestic Scheduled Payment Consents", nickname = "getDomesticScheduledPaymentConsentsConsentId", notes = "", response = OBWriteDomesticScheduledConsentResponse1.class, authorizations = {
            @Authorization(value = "TPPOAuth2Security", scopes = {
                    @AuthorizationScope(scope = "payments", description = "Generic payment scope")
            })
    }, tags = {"Domestic Scheduled Payments",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Domestic Scheduled Payment Consents Read", response = OBWriteDomesticScheduledConsentResponse1.class),
            @ApiResponse(code = 400, message = "Bad request", response = OBErrorResponse1.class),
            @ApiResponse(code = 401, message = "Unauthorized"),
            @ApiResponse(code = 403, message = "Forbidden"),
            @ApiResponse(code = 404, message = "Not found"),
    ...
    ResponseEntity<OBWriteDomesticScheduledConsentResponse1> getDomesticScheduledPaymentConsentsConsentId(
