...
import com.forgerock.openbanking.commons.services.openbanking.converter.payment.FRDomesticStandingOrderConsentConverter;
...
public class DomesticStandingOrdersApiController implements DomesticStandingOrdersApi {
    ...
    public ResponseEntity<OBWriteDomesticStandingOrderResponse2> createDomesticStandingOrders(
        ...
        String consentId = obWriteDomesticStandingOrder2Param.getData().getConsentId();
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteDomesticStandingOrderResponse2.class, obWriteDomesticStandingOrder2Param);
                        }
                );
    }
