...
public class TransactionsApiController implements TransactionsApi {
    ...
    public ResponseEntity<OBReadTransaction4> getAccountTransactions(
        ...
        return RSEndpointWrapperService.<OBReadTransaction4>transctionsEndpoint()
                ...
                .execute(
                        (accountRequest, permissions, transactionFrom, transactionTo, fromBookingDateTimeUPD, toBookingDateTimeUPD, pageNumber) -> {
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, additionalParams, OBReadTransaction4.class);
                        }
                );
    }
