...
import com.forgerock.openbanking.commons.services.openbanking.converter.payment.FRInternationalStandingOrderConsentConverter;
...
public class InternationalStandingOrdersApiController implements InternationalStandingOrdersApi {
    ...
    public InternationalStandingOrdersApiController(InternationalStandingOrderService paymentsService,
                                                    ...
                                                    FRInternationalStandingOrderConsentConverter frInternationalStandingOrderConsentConverter) {
    ...
    public ResponseEntity<OBWriteInternationalStandingOrderResponse1> createInternationalStandingOrders(
        ...
        FRInternationalStandingOrderConsent3 payment = paymentsService.getPayment(consentId);

        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                .authorization(authorization)
                .xFapiFinancialId(xFapiFinancialId)
                .payment(frInternationalStandingOrderConsentConverter.toFRInternationalConsent1(payment))
                .principal(principal)
                .filters(f -> {
                    f.verifyPaymentIdWithAccessToken();
                    f.verifyIdempotencyKeyLength(xIdempotencyKey);
                    f.verifyPaymentStatus();
                    f.verifyRiskAndInitiation(obWriteInternationalStandingOrder1Param.getData().getInitiation(), obWriteInternationalStandingOrder1Param.getRisk());
                ...
                .execute(
                        (String tppId) -> {
                            ...
                            OBInternationalStandingOrder3 initiation = payment.getInitiation();
                            ...
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, Collections.emptyMap(), OBWriteInternationalStandingOrderResponse1.class, obWriteInternationalStandingOrder1Param);
                        }
                );
    }
    ...
    public ResponseEntity<OBWriteInternationalStandingOrderResponse1> getInternationalStandingOrdersInternationalStandingOrderPaymentId(
        ...
        return rsEndpointWrapperService.paymentSubmissionEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            return rsStoreGateway.toRsStore(request, new HttpHeaders(), OBWriteInternationalStandingOrderResponse1.class);
                        }
                );
    }
