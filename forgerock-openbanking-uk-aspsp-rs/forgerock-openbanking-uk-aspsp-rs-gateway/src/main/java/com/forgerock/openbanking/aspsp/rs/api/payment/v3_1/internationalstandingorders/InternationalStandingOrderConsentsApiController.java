...
public class InternationalStandingOrderConsentsApiController implements InternationalStandingOrderConsentsApi {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InternationalStandingOrderConsentsApiController.class);
    ...
    @Override
    public ResponseEntity<OBWriteInternationalStandingOrderConsentResponse2> getInternationalStandingOrderConsentsConsentId(
        ...
        return rsEndpointWrapperService.paymentEndpoint()
                ...
                .execute(
                        (String tppId) -> {
                            HttpHeaders additionalHttpHeaders = new HttpHeaders();
                            additionalHttpHeaders.add("x-ob-client-id", tppId);
                            return rsStoreGateway.toRsStore(request, additionalHttpHeaders, OBWriteInternationalStandingOrderConsentResponse2.class);
                        }
                );
    }
