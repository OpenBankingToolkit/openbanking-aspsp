...
public class InternationalStandingOrderConsentsApiController implements InternationalStandingOrderConsentsApi {
    ...
    public ResponseEntity<OBWriteInternationalStandingOrderConsentResponse1> createInternationalStandingOrderConsents(
        ...
        FRInternationalStandingOrderConsent internationalStandingOrderConsent = FRInternationalStandingOrderConsent.builder()
                ...
                .internationalStandingOrderConsent(frInternationalStandingOrderConsent)
                .pispId(tpp.getId())
    ...
    private OBWriteInternationalStandingOrderConsentResponse1 packageResponse(FRInternationalStandingOrderConsent internationalStandingOrderConsent) {
