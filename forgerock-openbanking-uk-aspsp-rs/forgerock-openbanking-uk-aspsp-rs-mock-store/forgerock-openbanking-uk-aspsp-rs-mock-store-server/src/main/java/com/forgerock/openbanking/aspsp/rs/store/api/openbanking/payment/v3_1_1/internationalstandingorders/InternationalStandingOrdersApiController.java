 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_1.internationalstandingorders;
...
public class InternationalStandingOrdersApiController implements InternationalStandingOrdersApi {
    ...
    public ResponseEntity createInternationalStandingOrders(
            @ApiParam(value = "Default", required = true) @Valid @RequestBody OBWriteInternationalStandingOrder3 OBWriteInternationalStandingOrder3,
        ...
        String paymentId = OBWriteInternationalStandingOrder3.getData().getConsentId();
        ...
        FRInternationalStandingOrderPaymentSubmission4 frPaymentSubmission = FRInternationalStandingOrderPaymentSubmission4.builder()
                .id(paymentId)
                .internationalStandingOrder(toOBWriteInternationalStandingOrder4(OBWriteInternationalStandingOrder3))
                .created(new Date())
                .updated(new Date())
    ...
    private OBWriteInternationalStandingOrderResponse3 packagePayment(FRInternationalStandingOrderPaymentSubmission4 frPaymentSubmission, FRInternationalStandingOrderConsent5 frInternationalStandingOrderConsent) {
        return new OBWriteInternationalStandingOrderResponse3()
                .data(new OBWriteDataInternationalStandingOrderResponse3()
                    ...
                    .initiation(toOBInternationalStandingOrder3(frPaymentSubmission.getInternationalStandingOrder().getData().getInitiation()))
                ...
                .links(resourceLinkService.toSelfLink(frPaymentSubmission, discovery -> discovery.getV_3_1_1().getGetInternationalStandingOrder()))
                .meta(new Meta());
    }
}
