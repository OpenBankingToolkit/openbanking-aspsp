...
import static com.forgerock.openbanking.common.model.openbanking.persistence.payment.converter.v3_1_5.ResponseConverter.ReadRefundAccountConverter.toOBWriteDomesticStandingOrderConsentResponse6DataReadRefundAccount;
import static com.forgerock.openbanking.common.model.openbanking.persistence.payment.converter.v3_1_5.ResponseConverter.StatusCodeConverter.toOBWriteDomesticStandingOrderConsentResponse6DataStatus;
...
public class DomesticStandingOrderConsentsApiController implements DomesticStandingOrderConsentsApi {
    ...
    private OBWriteDomesticStandingOrderConsentResponse6 entityInstance(FRDomesticStandingOrderConsent domesticStandingOrderConsent) {
        return new OBWriteDomesticStandingOrderConsentResponse6()
                .data(new OBWriteDomesticStandingOrderConsentResponse6Data()
                        ...
                        .debtor(toOBDebtorIdentification1(domesticStandingOrderConsent.getInitiation().getDebtorAccount()))
                )
