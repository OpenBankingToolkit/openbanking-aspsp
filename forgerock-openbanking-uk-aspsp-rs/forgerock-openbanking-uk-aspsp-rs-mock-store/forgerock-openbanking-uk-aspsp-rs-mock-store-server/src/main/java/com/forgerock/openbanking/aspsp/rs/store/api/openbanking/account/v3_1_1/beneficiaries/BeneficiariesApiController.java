 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.account.v3_1_1.beneficiaries;
...
public class BeneficiariesApiController implements BeneficiariesApi {
    ...
    public ResponseEntity<OBReadBeneficiary3> getAccountBeneficiaries(
        ...
        Page<FRBeneficiary5> beneficiaries = frBeneficiaryRepository.byAccountIdWithPermissions(accountId, permissions,
        ...
        return ResponseEntity.ok(new OBReadBeneficiary3().data(new OBReadBeneficiary3Data().beneficiary(
                beneficiaries.getContent()
                        ...
                        .map(OBBeneficiaryConverter::toOBBeneficiary3)
    ...
    public ResponseEntity<OBReadBeneficiary3> getBeneficiaries(
        ...
        Page<FRBeneficiary5> beneficiaries = frBeneficiaryRepository.byAccountIdInWithPermissions(accountIds, permissions,
                PageRequest.of(page, PAGE_LIMIT_BENEFICIARIES));
        int totalPages = beneficiaries.getTotalPages();
