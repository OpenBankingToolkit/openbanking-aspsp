...
import com.forgerock.openbanking.aspsp.rs.store.repository.migration.legacy.payments.FRFilePaymentSubmission2;
...
public class FRFilePaymentSubmissionMigrator {

    public static FRFilePaymentSubmission toFRFilePaymentSubmission(FRFilePaymentSubmission2 submission2) {
        return submission2 == null ? null : FRFilePaymentSubmission.builder()
                .id(submission2.getId())
                .filePayment(toFRWriteFile(submission2.getFilePayment()))
