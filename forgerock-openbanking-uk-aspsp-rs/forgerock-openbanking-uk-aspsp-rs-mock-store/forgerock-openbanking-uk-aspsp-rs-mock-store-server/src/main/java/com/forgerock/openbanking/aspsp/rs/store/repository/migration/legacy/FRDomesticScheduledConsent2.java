...
@Builder
@Document
public class FRDomesticScheduledConsent2 implements FRPaymentConsent, Persistable<String> {
    @Id
    @Indexed
    public String id;
    @Indexed
    public ConsentStatusCode status;
    public OBWriteDomesticScheduledConsent2 domesticScheduledConsent;
