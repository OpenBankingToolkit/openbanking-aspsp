...
public class FilePaymentConsentsApiController implements FilePaymentConsentsApi {
    ...
    public ResponseEntity<OBWriteFileConsentResponse4> createFilePaymentConsents(
    ...
    public ResponseEntity<Void> createFilePaymentConsentsConsentIdFile(
        ...
        FRFileConsent5 fileConsent = fileConsentRepository.findById(consentId)
                .orElseThrow(() -> new OBErrorResponseException(
                        HttpStatus.BAD_REQUEST,
                        OBRIErrorResponseCategory.REQUEST_INVALID,
    ...
    public ResponseEntity<OBWriteFileConsentResponse4> getFilePaymentConsentsConsentId(
            String consentId,
            String authorization,
            DateTime xFapiAuthDate,
            String xFapiCustomerIpAddress,
    ...
    private OBWriteFileConsentResponse4 packageResponse(FRFileConsent5 fileConsent) {
