...
public class DomesticPaymentApiController implements DomesticPaymentApi {
    ...
    private final DomesticConsent2Repository consentRepository;
    private ConsentMetricService consentMetricService;

    @Autowired
    public DomesticPaymentApiController(DomesticConsent2Repository consentRepository, ConsentMetricService consentMetricService) {
    ...
    public ResponseEntity get(
        ...
        Optional<FRDomesticConsent2> byPaymentId = consentRepository.findById(paymentId);
    ...
    @Override
    public ResponseEntity<Collection<FRDomesticConsent2>> findByStatus(
    ...
    @Override
    public ResponseEntity<FRDomesticConsent2> update(
            @RequestBody FRDomesticConsent2 paymentSetup
    ) {
