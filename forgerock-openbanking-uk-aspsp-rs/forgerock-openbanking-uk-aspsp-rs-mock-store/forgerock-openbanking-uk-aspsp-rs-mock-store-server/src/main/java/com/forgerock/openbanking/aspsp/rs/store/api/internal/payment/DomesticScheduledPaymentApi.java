...
public interface DomesticScheduledPaymentApi {
    ...
    @RequestMapping(value = "/search/findByStatus",
            produces = {"application/json; charset=utf-8"},
            method = RequestMethod.GET)
    ResponseEntity<Collection<FRDomesticScheduledConsent>> findByStatus(
    ...
    ResponseEntity<FRDomesticScheduledConsent> update(
            @RequestBody FRDomesticScheduledConsent payment1
    );
}
