...
public class FilePaymentApiController implements FilePaymentApi {
    private final FileConsentRepository consentRepository;
    private ConsentMetricService consentMetricService;

    @Autowired
    public FilePaymentApiController(FileConsentRepository consentRepository, ConsentMetricService consentMetricService) {
