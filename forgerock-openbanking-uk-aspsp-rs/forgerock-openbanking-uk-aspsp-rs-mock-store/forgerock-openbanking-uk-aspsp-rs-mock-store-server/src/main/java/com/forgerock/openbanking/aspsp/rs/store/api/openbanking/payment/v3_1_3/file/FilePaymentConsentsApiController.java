...
public class FilePaymentConsentsApiController implements FilePaymentConsentsApi {
    ...
    public ResponseEntity<OBWriteFileConsentResponse3> createFilePaymentConsents(
        ...
        return new ResponseEntity<OBWriteFileConsentResponse3>(HttpStatus.NOT_IMPLEMENTED);

//        Tpp tpp = Optional.ofNullable(tppRepository.findByClientId(clientId))
...
//                .writeFileConsent(obWriteFileConsent3Param)
//                .pispId(tpp.getId())
