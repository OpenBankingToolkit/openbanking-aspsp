...
public class DomesticStandingOrdersApiController implements DomesticStandingOrdersApi {
    ...
    private OBWriteDomesticStandingOrderResponse2 packagePayment(FRDomesticStandingOrderPaymentSubmission3 frPaymentSubmission, FRDomesticStandingOrderConsent5 frDomesticStandingOrderConsent2) {
        return new OBWriteDomesticStandingOrderResponse2().data(new OBWriteDataDomesticStandingOrderResponse2()
                ...
                .links(resourceLinkService.toSelfLink(frPaymentSubmission, discovery -> discovery.getV_3_1().getGetDomesticStandingOrder()))
                .meta(new Meta());
    }
