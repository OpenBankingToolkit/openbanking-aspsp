...
import uk.org.openbanking.datamodel.vrp.v3_1_10.OBVRPFundsConfirmationResponseData;
...
import static com.forgerock.openbanking.common.services.openbanking.converter.vrp.FRDomesticVRPConsentConverter.toOBDomesticVRPConsentResponsev3_1_10;
...
@Controller("DomesticVrpConsentsApiControllerV3.1.10")
@Slf4j
public class DomesticVrpConsentsApiController implements DomesticVrpConsentsApi {
    ...
    public DomesticVrpConsentsApiController(
            ...
            ConsentMetricService consentMetricService, FRAccountRepository accountRepository) {
    ...
    private OBDomesticVRPConsentResponse packageResponse(FRDomesticVRPConsent frDomesticVRPConsent) {
        return toOBDomesticVRPConsentResponsev3_1_10(frDomesticVRPConsent)
                .links(
