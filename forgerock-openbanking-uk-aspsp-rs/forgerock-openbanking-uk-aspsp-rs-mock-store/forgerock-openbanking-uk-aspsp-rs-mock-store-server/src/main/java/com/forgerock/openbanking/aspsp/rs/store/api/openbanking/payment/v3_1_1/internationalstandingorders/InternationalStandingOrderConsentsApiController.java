...
public class InternationalStandingOrderConsentsApiController implements InternationalStandingOrderConsentsApi {
    ...
    public ResponseEntity<OBWriteInternationalStandingOrderConsentResponse3> createInternationalStandingOrderConsents(
        ...
        FRInternationalStandingOrderConsent3 internationalStandingOrderConsent = FRInternationalStandingOrderConsent3.builder()
                ...
                .internationalStandingOrderConsent(OBWriteInternationalStandingOrderConsent3Param)
                .pispId(tpp.getId())
    ...
    private OBWriteInternationalStandingOrderConsentResponse3 packageResponse(FRInternationalStandingOrderConsent3 internationalStandingOrderConsent) {
