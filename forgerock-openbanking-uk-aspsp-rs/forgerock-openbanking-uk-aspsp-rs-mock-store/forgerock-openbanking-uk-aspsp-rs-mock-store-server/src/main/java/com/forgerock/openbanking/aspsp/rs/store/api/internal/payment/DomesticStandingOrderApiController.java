...
public class DomesticStandingOrderApiController implements DomesticStandingOrderApi {
    ...
    private final DomesticStandingOrderConsentRepository consentRepository;

    @Autowired
    public DomesticStandingOrderApiController(DomesticStandingOrderConsentRepository consentRepository, ConsentMetricService consentMetricService) {
    ...
    public ResponseEntity get(
        ...
        Optional<FRDomesticStandingOrderConsent> byPaymentId = consentRepository.findById(paymentId);
    ...
    @Override
    public ResponseEntity<Collection<FRDomesticStandingOrderConsent>> findByStatus(
    ...
    @Override
    public ResponseEntity<FRDomesticStandingOrderConsent> update(
            @RequestBody FRDomesticStandingOrderConsent paymentSetup
    ) {
