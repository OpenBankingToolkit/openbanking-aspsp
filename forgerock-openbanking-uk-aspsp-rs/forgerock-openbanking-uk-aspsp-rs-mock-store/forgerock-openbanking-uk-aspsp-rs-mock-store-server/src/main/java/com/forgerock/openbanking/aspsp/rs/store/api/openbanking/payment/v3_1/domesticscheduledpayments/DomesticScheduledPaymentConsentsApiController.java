...
public class DomesticScheduledPaymentConsentsApiController implements DomesticScheduledPaymentConsentsApi {
    ...
    public ResponseEntity<OBWriteDomesticScheduledConsentResponse2> createDomesticScheduledPaymentConsents(
        ...
        FRDomesticScheduledConsent4 domesticScheduledConsent = FRDomesticScheduledConsent4.builder()
                ...
                .domesticScheduledConsent(toOBWriteDomesticScheduledConsent3(obWriteDomesticScheduledConsent2Param))
                .pispId(tpp.getId())
    ...
    private OBWriteDomesticScheduledConsentResponse2 packageResponse(FRDomesticScheduledConsent4 domesticScheduledConsent) {
        return new OBWriteDomesticScheduledConsentResponse2()
                .data(new OBWriteDataDomesticScheduledConsentResponse2()
                        .initiation(toOBDomesticScheduled2(domesticScheduledConsent.getInitiation()))
