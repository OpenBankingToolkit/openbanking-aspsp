...
public class InternationalStandingOrderApiController implements InternationalStandingOrderApi {
    ...
    private final InternationalStandingOrderConsentRepository consentRepository;
    private ConsentMetricService consentMetricService;

    @Autowired
    public InternationalStandingOrderApiController(InternationalStandingOrderConsentRepository consentRepository,
    ...
    public ResponseEntity get(
        ...
        Optional<FRInternationalStandingOrderConsent> byPaymentId = consentRepository.findById(paymentId);
    ...
    @Override
    public ResponseEntity<Collection<FRInternationalStandingOrderConsent>> findByStatus(
    ...
    @Override
    public ResponseEntity<FRInternationalStandingOrderConsent> update(
            @RequestBody FRInternationalStandingOrderConsent paymentSetup
    ) {
