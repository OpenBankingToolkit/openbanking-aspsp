...
public class DomesticScheduledPaymentApiController implements DomesticScheduledPaymentApi {
    ...
    private final DomesticScheduledConsentRepository consentRepository;
    private ConsentMetricService consentMetricService;

    @Autowired
    public DomesticScheduledPaymentApiController(DomesticScheduledConsentRepository consentRepository, ConsentMetricService consentMetricService) {
