...
public class InternationalStandingOrderConsentsApiController implements InternationalStandingOrderConsentsApi {
    ...
    public ResponseEntity<OBWriteInternationalStandingOrderConsentResponse2> createInternationalStandingOrderConsents(
            ...
            @Valid
            @RequestBody OBWriteInternationalStandingOrderConsent2 obWriteInternationalStandingOrderConsent2,
        ...
        log.debug("Received: '{}'", obWriteInternationalStandingOrderConsent2);
        FRWriteInternationalStandingOrderConsent frStandingOrderConsent = toFRWriteInternationalStandingOrderConsent(obWriteInternationalStandingOrderConsent2);
    ...
    private OBWriteInternationalStandingOrderConsentResponse2 packageResponse(FRInternationalStandingOrderConsent internationalStandingOrderConsent) {
