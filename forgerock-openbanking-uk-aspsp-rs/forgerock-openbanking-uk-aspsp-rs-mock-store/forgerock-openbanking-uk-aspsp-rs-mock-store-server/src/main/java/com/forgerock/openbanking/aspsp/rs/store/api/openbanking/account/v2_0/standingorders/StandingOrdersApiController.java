...
import com.forgerock.openbanking.common.model.openbanking.persistence.account.v2_0.FRStandingOrder2;
...
import uk.org.openbanking.datamodel.account.OBReadStandingOrder2Data;
...
@Controller("StandingOrdersApiV2.0")
public class StandingOrdersApiController implements StandingOrdersApi {
    ...
    public ResponseEntity<OBReadStandingOrder2> getAccountStandingOrders(
        ...
        return ResponseEntity.ok(new OBReadStandingOrder2()
                .data(new OBReadStandingOrder2Data().standingOrder(standingOrders))
                .links(PaginationUtil.generateLinks(httpUrl, page, totalPages))
                .meta(PaginationUtil.generateMetaData(totalPages)));
    }

    @Override
    public ResponseEntity<OBReadStandingOrder2> getStandingOrders(
