...
public class InternationalScheduledPaymentConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.4/pisp/international-scheduled-payment-consents/";
    ...
    public void testGetInternationalScheduledPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalScheduledConsentResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + consent.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
