...
public class FRFRExchangeRateInformationTestDataFactory {

    public static FRExchangeRateInformation aValidFRExchangeRateInformation() {
        return FRExchangeRateInformation.builder()
                .unitCurrency("GBP")
                .exchangeRate(new BigDecimal(1.1))
                .rateType(FRExchangeRateInformation.FRRateType.INDICATIVE)
                .build();
    }
}
