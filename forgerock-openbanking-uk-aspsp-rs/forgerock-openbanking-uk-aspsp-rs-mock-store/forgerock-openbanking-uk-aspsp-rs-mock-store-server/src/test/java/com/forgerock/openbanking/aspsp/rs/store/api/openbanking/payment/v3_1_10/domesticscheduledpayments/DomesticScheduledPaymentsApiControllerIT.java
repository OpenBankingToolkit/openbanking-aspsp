...
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_10.domesticscheduledpayments;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_5.domesticscheduledpayments.DomesticScheduledPaymentsApiController;
...
public class DomesticScheduledPaymentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.10/pisp/domestic-scheduled-payments/";
    ...
    public void testCreateDomesticPaymentSubmission() throws UnirestException {
        ...
        HttpResponse<OBWriteDomesticScheduledResponse5> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                ...
                .asObject(OBWriteDomesticScheduledResponse5.class);

        // Then
        assertThat(response.getStatus()).isEqualTo(201);
        OBWriteDomesticScheduledResponse5 consentResponse = response.getBody();
    ...
    public void testCreateDomesticPaymentSubmission_expectRefundAccount() throws UnirestException {
        ...
        // Then
        assertThat(response.getStatus()).isEqualTo(201);
        OBWriteDomesticScheduledResponse5 rBody = response.getBody();
        FRDomesticScheduledPaymentSubmission submission = submissionRepository.findById(response.getBody().getData().getDomesticScheduledPaymentId()).get();
    ...
    public void testGetDomesticPaymentSubmission() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticScheduledResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + submission.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteDomesticScheduledResponse5.class);

        // Then
        OBWriteDomesticScheduledResponse5Data bodyData = response.getBody().getData();
