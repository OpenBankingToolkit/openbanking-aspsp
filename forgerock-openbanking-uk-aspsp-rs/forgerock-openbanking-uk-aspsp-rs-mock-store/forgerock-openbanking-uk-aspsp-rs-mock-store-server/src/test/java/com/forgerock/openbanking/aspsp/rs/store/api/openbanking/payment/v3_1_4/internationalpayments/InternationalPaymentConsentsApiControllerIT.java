...
public class InternationalPaymentConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.4/pisp/international-payment-consents/";
    ...
    public void testGetInternationalPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalConsentResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + consent.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteInternationalConsentResponse5.class);
    ...
    public void testCreateInternationalPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalConsentResponse5> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
        ...
        OBWriteInternationalConsentResponse5 consentResponse = response.getBody();
