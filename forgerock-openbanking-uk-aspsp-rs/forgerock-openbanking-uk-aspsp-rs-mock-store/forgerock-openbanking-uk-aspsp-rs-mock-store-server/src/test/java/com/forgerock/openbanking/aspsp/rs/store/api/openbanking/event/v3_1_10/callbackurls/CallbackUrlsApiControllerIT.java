 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.event.v3_1_10.callbackurls;
...
public class CallbackUrlsApiControllerIT {
    ...
    public void createCallbackUrls_urlDoesNotExistForTpp_created() {
        ...
        OBCallbackUrl1 obCallbackUrl = new OBCallbackUrl1()
                .data(new OBCallbackUrlData1()
                        .url(url)
                        .version(OBVersion.v3_1_10.getCanonicalVersion())
                );

        // When
        HttpResponse<OBCallbackUrlResponse1> response = Unirest.post("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls")
        ...
        assertThat(response.getBody().getData().getVersion()).isEqualTo(OBVersion.v3_1_10.getCanonicalVersion());
    ...
    public void createCallbackUrls_urlAlreadyExistsForTpp_conflict() throws Exception {
        ...
        // When
        HttpResponse response = Unirest.post("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void readCallBackUrls_noResults_emptyData() {
        ...
        // When
        HttpResponse<OBCallbackUrlResponse1> response = Unirest.get("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void readCallBackUrls_accessedByNewerApiVersion() {
        ...
        HttpResponse<OBCallbackUrlsResponse1> getResponse = Unirest.get("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void updateCallbackUrl_exists_updated() {
        ...
        // When
        HttpResponse<OBCallbackUrlResponse1> response = Unirest.put("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls/"+callbackId)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void updateCallbackUrl_doesNotExist_notFound() {
        ...
        // When
        HttpResponse response = Unirest.put("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls/"+UUID.randomUUID())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void deleteCallbackUrl_exists_deleted() {
        ...
        // When
        HttpResponse response = Unirest.delete("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls/"+callbackId)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
    ...
    public void deleteCallbackUrl_doesNotExist_notFound() {
        ...
        // When
        HttpResponse response = Unirest.delete("https://rs-store:" + port + "/open-banking/"+OBVersion.v3_1_10.getCanonicalName()+"/callback-urls/"+ UUID.randomUUID())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header("x-ob-client-id", clientId)
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
