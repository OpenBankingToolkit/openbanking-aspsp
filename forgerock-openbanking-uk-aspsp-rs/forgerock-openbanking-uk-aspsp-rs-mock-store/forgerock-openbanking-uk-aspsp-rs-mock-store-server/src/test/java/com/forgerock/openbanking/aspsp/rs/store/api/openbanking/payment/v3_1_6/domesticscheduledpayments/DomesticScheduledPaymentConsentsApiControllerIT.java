...
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_5.domesticscheduledpayments.DomesticScheduledPaymentConsentsApiController;
...
public class DomesticScheduledPaymentConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.6/pisp/domestic-scheduled-payment-consents/";
    ...
    public void testGetDomesticScheduledPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticScheduledConsentResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + consent.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteDomesticScheduledConsentResponse5.class);
    ...
    @Test
    public void testGetDomesticScheduledPaymentConsent_refundNull() throws UnirestException {
        // Given
        springSecForTest.mockAuthCollector.mockAuthorities(OBRIRole.ROLE_PISP);
    ...
    public void testCreateDomesticScheduledPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticScheduledConsentResponse5> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                ...
                .body(aValidOBWriteDomesticScheduledConsent4())
                .asObject(OBWriteDomesticScheduledConsentResponse5.class);

        // Then
        log.error("The response: {}", response);
        assertThat(response.getStatus()).isEqualTo(201);
        OBWriteDomesticScheduledConsentResponse5 consentResponse = response.getBody();
