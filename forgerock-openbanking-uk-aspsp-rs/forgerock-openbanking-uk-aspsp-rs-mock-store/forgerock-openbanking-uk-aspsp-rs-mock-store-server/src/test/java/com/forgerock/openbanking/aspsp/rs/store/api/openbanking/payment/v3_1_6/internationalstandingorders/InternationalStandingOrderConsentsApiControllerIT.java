...
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_5.internationalstandingorders.InternationalStandingOrderConsentsApiController;
...
public class InternationalStandingOrderConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.6/pisp/international-standing-order-consents/";
    ...
    public void testCreateInternationalStandingOrderPaymentConsent() throws UnirestException {
        ...
        assertThat(consent.getVersion()).isEqualTo(OBVersion.v3_1_6);
    }
    ...
    private FRInternationalStandingOrderConsent saveFRConsent(FRReadRefundAccount frReadRefundAccount, ConsentStatusCode consentStatusCode) {
        ...
        consent.setVersion(OBVersion.v3_1_6);
