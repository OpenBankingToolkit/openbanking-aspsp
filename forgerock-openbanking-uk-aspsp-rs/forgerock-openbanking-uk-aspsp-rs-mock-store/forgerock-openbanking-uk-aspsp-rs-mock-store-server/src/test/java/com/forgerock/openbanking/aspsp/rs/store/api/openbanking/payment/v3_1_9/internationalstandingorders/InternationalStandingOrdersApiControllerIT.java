...
public class InternationalStandingOrdersApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.9/pisp/international-standing-orders/";
    ...
    public void testCreateInternationalStandingOrderPaymentSubmission() throws UnirestException {
        ...
        assertThat(submission.getVersion()).isEqualTo(OBVersion.v3_1_9);
    }
