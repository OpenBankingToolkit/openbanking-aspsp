...
public class DomesticStandingOrderConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.4/pisp/domestic-standing-order-consents/";
    ...
    public void testGetDomesticStandingOrderPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticStandingOrderConsentResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + consent.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteDomesticStandingOrderConsentResponse5.class);
    ...
    public void testCreateDomesticStandingOrderPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticStandingOrderConsentResponse5> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
        ...
        OBWriteDomesticStandingOrderConsentResponse5 consentResponse = response.getBody();
