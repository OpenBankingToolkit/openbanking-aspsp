 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.funds.v3_1_9;
...
public class FundsConfirmationsApiControllerIT {
    ...
    public void testGetFundsConfirmation() throws UnirestException {
        ...
        // When
        HttpResponse<OBFundsConfirmationResponse1> response = Unirest.get("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_9.getCanonicalName() + "/cbpii/funds-confirmations/" + fundsConfirmation.getId())
    ...
    public void testGetMissing_ReturnNotFound() throws UnirestException {
        ...
        // When
        HttpResponse<String> response = Unirest.get("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_9.getCanonicalName() + "/cbpii/funds-confirmations/12345")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
    ...
    public void testGetFundsConfirmationWithMissingConsent_ReturnNotFound() throws UnirestException {
        ...
        // When
        HttpResponse<String> response = Unirest.get("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_9.getCanonicalName() + "/cbpii/funds-confirmations/" + submission.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(String.class);
    ...
    public void testCreateFundsConfirmation() throws UnirestException {
        ...
        // When
        HttpResponse<OBFundsConfirmationResponse1> response = Unirest.post("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_9.getCanonicalName() + "/cbpii/funds-confirmations")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
    ...
    public void testDuplicateCreation_UpdateAndReturn() throws Exception {
        ...
        // When
        HttpResponse<String> response = Unirest.post("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_9.getCanonicalName() + "/cbpii/funds-confirmations")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .header(OBHeaders.X_JWS_SIGNATURE, "x-jws-signature")
                .header(OBHeaders.CONTENT_TYPE, "application/json; charset=utf-8")
