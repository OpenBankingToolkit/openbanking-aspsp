...
/**
 * Integration test for {@link com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_7.domesticpayments.DomesticPaymentConsentsApiController}.
 */
...
public class DomesticPaymentConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.7/pisp/domestic-payment-consents/";
    ...
    public void testCreateDomesticPaymentConsent() throws UnirestException {
        ...
        assertThat(consent.getObVersion()).isEqualTo(OBVersion.v3_1_7);
    }
