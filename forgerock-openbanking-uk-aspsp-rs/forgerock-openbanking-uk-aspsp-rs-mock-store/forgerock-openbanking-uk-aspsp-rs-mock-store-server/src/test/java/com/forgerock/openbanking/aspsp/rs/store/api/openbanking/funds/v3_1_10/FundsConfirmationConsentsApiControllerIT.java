...
/**
 * SpringBoot test for {@link com.forgerock.openbanking.aspsp.rs.store.api.openbanking.funds.v3_1_10.FundsConfirmationsApiController}.
 */
...
public class FundsConfirmationConsentsApiControllerIT {
    ...
    public void testGetConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBFundsConfirmationConsentResponse1> response = Unirest.get("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_10.getCanonicalName() + "/cbpii/funds-confirmation-consents/" + consent.getId())
    ...
    public void testGetConsentReturnNotFound() throws UnirestException {
        ...
        // When
        HttpResponse<String> response = Unirest.get("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_10.getCanonicalName() + "/cbpii/funds-confirmation-consents/12345")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
    ...
    public void testCreateConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBFundsConfirmationConsentResponse1> response = Unirest.post("https://rs-store:" + port + "/open-banking/" + OBVersion.v3_1_10.getCanonicalName() + "/cbpii/funds-confirmation-consents/")
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
