...
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_10.internationalstandingorders.InternationalStandingOrderConsentsApiController;
...
public class InternationalStandingOrderConsentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.10/pisp/international-standing-order-consents/";
    ...
    public void testGetInternationalStandingOrderPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalStandingOrderConsentResponse7> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + consent.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteInternationalStandingOrderConsentResponse7.class);
    ...
    public void testCreateInternationalStandingOrderPaymentConsent() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalStandingOrderConsentResponse7> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
        ...
        OBWriteInternationalStandingOrderConsentResponse7 consentResponse = response.getBody();
        ...
        assertThat(toOBWriteInternationalStandingOrderConsentResponse7DataInitiation(consent.getInitiation())).isEqualTo(consentResponse.getData().getInitiation());
        ...
        assertThat(consent.getVersion()).isEqualTo(OBVersion.v3_1_10);
    }
    ...
    private FRInternationalStandingOrderConsent saveFRConsent(FRReadRefundAccount frReadRefundAccount, ConsentStatusCode consentStatusCode) {
        ...
        consent.setVersion(OBVersion.v3_1_10);
