 ...
 * under the License.
 */
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.account.v3_1_10.accounts;
...
/**
 * SpringBoot test for {@link com.forgerock.openbanking.aspsp.rs.store.api.openbanking.account.v3_1_10.accounts.AccountsApiController}.
 */
...
public class AccountsApiControllerIT {
    ...
    public void testGetAnAccount() throws UnirestException {
        ...
        // When
        HttpResponse<OBReadAccount6> response = Unirest.get("https://rs-store:" + port + "/open-banking/v3.1.10/aisp/accounts/" + account.getId())
