...
package com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_7.domesticpayments;
...
/**
 * Spring Integration test for {@link com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_7.domesticpayments.DomesticPaymentsApiController}.
 */
...
public class DomesticPaymentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.7/pisp/domestic-payments/";
    ...
    public void testGetDomesticPaymentSubmission() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteDomesticResponse5> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + submission.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteDomesticResponse5.class);
