...
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_5.internationalstandingorders.InternationalStandingOrdersApiController;
...
public class InternationalStandingOrdersApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.6/pisp/international-standing-orders/";
    ...
    public void testCreateInternationalStandingOrderPaymentSubmission() throws UnirestException {
        ...
        assertThat(submission.getVersion()).isEqualTo(OBVersion.v3_1_6);
    }
