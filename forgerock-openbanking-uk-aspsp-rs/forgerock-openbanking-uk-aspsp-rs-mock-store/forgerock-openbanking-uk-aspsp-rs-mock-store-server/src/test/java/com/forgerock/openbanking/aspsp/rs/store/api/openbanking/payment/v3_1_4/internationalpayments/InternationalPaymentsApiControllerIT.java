...
public class InternationalPaymentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.4/pisp/international-payments/";
    ...
    public void testCreateInternationalPaymentSubmission() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalResponse4> response = Unirest.post(RS_STORE_URL + port + CONTEXT_PATH)
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                ...
                .asObject(OBWriteInternationalResponse4.class);

        // Then
        assertThat(response.getStatus()).isEqualTo(201);
        OBWriteInternationalResponse4 consentResponse = response.getBody();
    ...
    public void testCreateInternationalPaymentSubmission_expectRefundAccount() throws UnirestException {
        ...
        // Then
        assertThat(response.getStatus()).isEqualTo(201);
        OBWriteInternationalResponse4 rBody = response.getBody();
        FRInternationalPaymentSubmission submission = submissionRepository.findById(response.getBody().getData().getInternationalPaymentId()).get();
    ...
    public void testGetInternationalPaymentSubmission() throws UnirestException {
        ...
        // When
        HttpResponse<OBWriteInternationalResponse4> response = Unirest.get(RS_STORE_URL + port + CONTEXT_PATH + submission.getId())
                .header(OBHeaders.X_FAPI_FINANCIAL_ID, rsConfiguration.financialId)
                .header(OBHeaders.AUTHORIZATION, "token")
                .asObject(OBWriteInternationalResponse4.class);

        // Then
        OBWriteInternationalResponse4Data bodyData = response.getBody().getData();
