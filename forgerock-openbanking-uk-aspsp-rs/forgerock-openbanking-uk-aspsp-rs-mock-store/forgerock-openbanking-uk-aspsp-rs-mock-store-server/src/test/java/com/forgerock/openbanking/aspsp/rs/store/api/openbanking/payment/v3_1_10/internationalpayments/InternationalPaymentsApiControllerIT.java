...
import com.forgerock.openbanking.aspsp.rs.store.api.openbanking.payment.v3_1_10.internationalpayments.InternationalPaymentsApiController;
...
public class InternationalPaymentsApiControllerIT {
    ...
    private static final String CONTEXT_PATH = "/open-banking/v3.1.10/pisp/international-payments/";
