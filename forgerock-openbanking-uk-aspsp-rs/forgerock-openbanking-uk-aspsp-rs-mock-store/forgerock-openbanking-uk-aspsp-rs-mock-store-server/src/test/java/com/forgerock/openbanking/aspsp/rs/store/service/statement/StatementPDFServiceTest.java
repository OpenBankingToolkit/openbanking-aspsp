...
public class StatementPDFServiceTest {
    ...
    @Mock
    private GCPBucketStorageAccessor bucketStorageAccessor;
    @Mock
    ...
    public void setup() {
        ...
        given(bucketStorageAccessor.getStorage()).willReturn(storage);
    }
    ...
    public void getPdfStatement_test_found() {
        ...
        StatementPDFService statementPDFService = new StatementPDFService(bucketStorageAccessor, BUCKET_NAME, resourcePath);
        ...
        assertThat(resource.orElseThrow(IllegalStateException::new).getDescription())
                .containsIgnoringCase("[Resource ob-sandbox-storage/statements/statement-exists.pdf loaded through InputStream]");
    }
