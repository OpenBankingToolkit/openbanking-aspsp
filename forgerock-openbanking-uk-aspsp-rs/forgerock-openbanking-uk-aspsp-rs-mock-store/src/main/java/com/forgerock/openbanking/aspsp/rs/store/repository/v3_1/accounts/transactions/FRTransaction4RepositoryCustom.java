...
public interface FRTransaction4RepositoryCustom {

    Page<FRTransaction4> byAccountIdAndBookingDateTimeBetweenWithPermissions(
    ...
    Page<FRTransaction4> byAccountIdAndStatementIdAndBookingDateTimeBetweenWithPermissions(
            @Param("accountId") String accountId,
    ...
    Page<FRTransaction4> byAccountIdInWithPermissions(List<String> accountIds, List<OBExternalPermissions1Code>
            permissions, Pageable pageable);

    Page<FRTransaction4> byAccountIdInAndBookingDateTimeBetweenWithPermissions(List<String> accountIds,
