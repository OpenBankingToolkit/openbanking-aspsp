...
@Service
@Slf4j
public class DomesticStandingOrdersPaymentConsentDecisionFactory {
    ...
    public DomesticStandingOrdersPaymentConsentDecisionFactory(PaymentConsentDecisionUpdater paymentConsentDecisionUpdater, DomesticStandingOrderService paymentsService, ObjectMapper objectMapper) {
    ...
    public ConsentDecisionDelegate create(final String intentId) {
        FRDomesticStandingOrderConsent3 consent = paymentsService.getPayment(intentId);
        return new DomesticStandingOrdersConsentDecisionDelegate(paymentConsentDecisionUpdater, paymentsService, objectMapper, consent);
    }
