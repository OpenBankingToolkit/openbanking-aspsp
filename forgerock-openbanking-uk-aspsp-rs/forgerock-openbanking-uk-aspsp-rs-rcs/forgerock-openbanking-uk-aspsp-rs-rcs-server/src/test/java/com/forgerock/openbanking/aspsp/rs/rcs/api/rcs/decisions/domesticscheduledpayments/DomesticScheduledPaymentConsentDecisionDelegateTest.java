...
public class DomesticScheduledPaymentConsentDecisionDelegateTest extends AbstractDecisionDelegateTest {
    ...
    private FRDomesticScheduledConsent5 consent;
    ...
    public void setup() {
        ...
        consent = FRDomesticScheduledConsent5.builder()
                .id(CONSENT_ID)
                .pispId(PISP_ID)
                .userId(USER_ID)
                .build();
        decisionDelegate = new DomesticScheduledPaymentConsentDecisionDelegate(
    ...
    @Test
    public void consentDecision_userAuthorised_missingAccountId_exception() throws Exception {
        // Given
