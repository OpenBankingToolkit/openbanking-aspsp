...
import com.forgerock.openbanking.commons.services.aspsp.ManualOnboardingService;
...
import com.forgerock.openbanking.register.api.user.UserApi;
...
public class ManualRegistrationApiController implements ManualRegistrationApi {
    ...
    public ResponseEntity<ManualRegistrationApplication> registerApplication(
        ...
        ManualRegUser manualRegUser = userApi.fromUserContext(currentUser);
        try {
