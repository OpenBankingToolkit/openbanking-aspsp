...
import com.forgerock.openbanking.common.services.onboarding.registrationrequest.JWTClaimsOrigin;
import com.forgerock.openbanking.common.services.onboarding.registrationrequest.RegistrationRequest;
import com.forgerock.openbanking.common.services.onboarding.registrationrequest.RegistrationRequestJWTClaims;
...
public class TppRegistrationServiceTest {
    ...
    private TokenExtractor tokenExtractor = mock(TokenExtractor.class);
    ...
    public void setUp() {
        this.tppRegistrationService = new TppRegistrationService(this.cryptoApiClient,
            ...
            this.tppStoreService, this.amoidcRegistrationService, this.tppEntriesKPIService, tokenExtractor);
    ...
    public void shouldFailWhenRequestRedirectUriNotInSsa_verifyTppRegistrationRequestAgainstSSA(){
        ...
        // When
        DynamicClientRegistrationException exception = catchThrowableOfType(() ->
                        tppRegistrationService.verifyTPPRegistrationRequestAgainstSSA(this.registrationRequest), DynamicClientRegistrationException.class);
    ...
    public void getTpp_success() throws OAuth2InvalidClientException {
        ...
        when(tppStoreService.findByClientId(clientId)).thenReturn(Optional.of(TestHelperFunctions.getValidTpp(clientId,
                "tppName")));
    ...
    public void ensureTppOwnsOidcRegistration_ThrowsWhenNoMatch() throws OAuth2InvalidClientException {
        ...
        // When
        Exception e = catchThrowableOfType(() -> tppRegistrationService.ensureTppOwnsOidcRegistration(tpp, "PSDUK-FCA" +
                        "-54321"), Exception.class);
