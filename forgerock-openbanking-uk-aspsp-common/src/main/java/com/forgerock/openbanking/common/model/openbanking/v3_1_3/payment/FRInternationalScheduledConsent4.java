 ...
 * under the License.
 */
package com.forgerock.openbanking.common.model.openbanking.v3_1_3.payment;
...
@Builder
@Document
public class FRInternationalScheduledConsent4 implements FRPaymentConsent, Persistable<String> {
    @Id
    @Indexed
    public String id;
    @Indexed
    public ConsentStatusCode status;
    public OBWriteInternationalScheduledConsent4 internationalScheduledConsent;
     ...
     */
    public OBWriteInternationalConsentResponse4DataExchangeRateInformation getCalculatedExchangeRate() {
