 ...
 * under the License.
 */
package com.forgerock.openbanking.common.model.openbanking.persistence.customerinfo;
...
@NoArgsConstructor
@Builder
public class FRCustomerInfoConsent implements AccountRequest, Persistable<String> {
    @Id
    @Indexed
    public String id;
