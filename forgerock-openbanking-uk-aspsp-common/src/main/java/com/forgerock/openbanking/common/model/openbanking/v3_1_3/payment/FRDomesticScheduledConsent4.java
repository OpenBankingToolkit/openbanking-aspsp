...
@Builder
@Document
public class FRDomesticScheduledConsent4 implements FRPaymentConsent, Persistable<String> {
    @Id
    @Indexed
    public String id;
    @Indexed
    public ConsentStatusCode status;
    public OBWriteDomesticScheduledConsent3 domesticScheduledConsent;
