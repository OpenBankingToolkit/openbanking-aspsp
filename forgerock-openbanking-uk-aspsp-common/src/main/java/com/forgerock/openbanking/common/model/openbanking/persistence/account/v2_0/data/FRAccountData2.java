 ...
 * under the License.
 */
package com.forgerock.openbanking.common.model.openbanking.persistence.account.v2_0.data;
...
public class FRAccountData2 {
    ...
    public List<OBStandingOrder2> standingOrders = new ArrayList<>();
    public List<OBTransaction2> transactions = new ArrayList<>();
    ...
    public OBProduct2 getProduct() {
        return product;
    }

    public void setProduct(OBProduct2 product) {
    ...
    public List<OBStandingOrder2> getStandingOrders() {
        return standingOrders;
    }

    public void setStandingOrders(List<OBStandingOrder2> standingOrders) {
        this.standingOrders = standingOrders;
    }


    public void addStandingOrder(OBStandingOrder2 standingOrder2) {
        standingOrders.add(standingOrder2);
    }

    public List<OBTransaction2> getTransactions() {
        return transactions;
    }

    public void setTransactions(List<OBTransaction2> transactions) {
        this.transactions = transactions;
    }

    public void addTransaction(OBTransaction2 transaction2) {
