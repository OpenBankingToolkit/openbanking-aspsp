...
@Builder
@Document
public class FRInternationalStandingOrderConsent4 implements FRPaymentConsent, Persistable<String> {
    @Id
    @Indexed
    public String id;
    @Indexed
    public ConsentStatusCode status;
    public OBWriteInternationalStandingOrderConsent5 internationalStandingOrderConsent;
