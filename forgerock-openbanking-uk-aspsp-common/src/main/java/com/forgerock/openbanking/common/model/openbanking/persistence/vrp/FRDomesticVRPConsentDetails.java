...
/**
 * Represents an equivalent object in the OB data model 'OBDomesticVRPDetails'. It is stored within mongo (instead of the OB object), in order to make it easier to introduce new
...
@AllArgsConstructor
@Builder
public class FRDomesticVRPConsentDetails {
    private FRDomesticVRPConsentDetailsData data;
