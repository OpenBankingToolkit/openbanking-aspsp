...
@Slf4j
@Component
public class Psd2WithSessionApiHelperService {

    private final CryptoApiClient cryptoApiClient;

    public Psd2WithSessionApiHelperService(CryptoApiClient cryptoApiClient) {
     ...
     */
    public @NotNull String getTppName(Principal principal) throws OAuth2InvalidClientException {
        String tppName = null;
