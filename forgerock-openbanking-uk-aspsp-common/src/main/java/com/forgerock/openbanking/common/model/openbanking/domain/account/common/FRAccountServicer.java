...
/**
 * Equivalent to {@link uk.org.openbanking.datamodel.account.OBBranchAndFinancialInstitutionIdentification50}. It is stored within mongo
 * (instead of the OB object), in order to make it easier to introduce new versions of the Read/Write API.
 *
 * <p>
 * From the OB docs:  Party that manages the account on behalf of the account owner, that is manages the registration and booking of entries on the account,
