      ...
      balances: [
        {
          ...
          Amount: { Amount: '195.75', Currency: 'GBP' }
        }
      ]
    },
    {
      ...
      balances: [
        {
          ...
          Type: 'InterimAvailable',
          DateTime: '2019-02-09T16:13:11+00:00',
          Amount: { Amount: '894.32', Currency: 'EUR' }
        }
      ]
    },
    {
      ...
      account: {
        ...
        AccountSubType: 'CurrentAccount',
        Nickname: 'Household',
        Account: [{ SchemeName: 'SortCodeAccountNumber', Identification: '36706024057704', Name: 'demo' }]
      },
      ...
      balances: [
        {
          ...
          Amount: { Amount: '819.91', Currency: 'GBP' }
        }
      ]
    }
  ],
