...
const log = debug('cdr-consent:DynamicComponent');

@Component({
  selector: 'app-cdr-consent-dynamic',
  template: `
    <ng-template #dynamicTarget></ng-template>
  `,
  styleUrls: ['./cdr-consent-dynamic.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class CDRConsentDynamicComponent implements OnInit, OnChanges {
  ...
  create(response) {
    ...
    switch (response.intentType) {
      ...
      case IntentType.ACCOUNT_ACCESS_CONSENT:
        componentInstance = CDRAccountComponent;
        break;
